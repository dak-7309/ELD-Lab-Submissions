...
proc create_root_design { parentCell } {
  ...
  set Led_ip_0 [ create_bd_cell -type ip -vlnv edu.in:user:Led_ip:1.0 Led_ip_0 ]
  ...
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins Buttons/s_axi_aresetn] [get_bd_pins Led_ip_0/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]
