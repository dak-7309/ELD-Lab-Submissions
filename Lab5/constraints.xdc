...
#set_property PACKAGE_PIN V2 [get_ports {opp}]					
...
##Buttons
set_property PACKAGE_PIN U18 [get_ports bouncer]						
	set_property IOSTANDARD LVCMOS33 [get_ports bouncer]
...
##Pmod Header JB
##Sch name = JB1
set_property PACKAGE_PIN A14 [get_ports {cathode1[6]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {cathode1[6]}]
###Sch name = JB2
set_property PACKAGE_PIN A16 [get_ports {cathode1[5]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {cathode1[5]}]
###Sch name = JB3
set_property PACKAGE_PIN B15 [get_ports {cathode1[4]}]					
...
##Pmod Header JC
##Sch name = JC1
set_property PACKAGE_PIN K17 [get_ports {cathode1[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {cathode1[2]}]
###Sch name = JC2
set_property PACKAGE_PIN M18 [get_ports {cathode1[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {cathode1[1]}]
###Sch name = JC3
set_property PACKAGE_PIN N17 [get_ports {cathode1[0]}]					
...
#set_property ALLOW_COMBINATIONAL_LOOPS [get_nets -of_objects [get_cells cathode_OBUF[7]]]
